...
package com.semanticcms.section.servlet.book;
...
@WebServlet("/section/servlet/apidocs/com/*")
public class ModularApidocsRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    HttpServletUtil.sendRedirect(
        ...
        "/section/servlet/apidocs/com.semanticcms.section.servlet/com" + Objects.toString(req.getPathInfo(), ""),
